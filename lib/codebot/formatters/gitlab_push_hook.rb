  ...
  module Formatters
    module Gitlab
      ...
      class PushHook < Formatter # rubocop:disable Metrics/ClassLength
        # Formats IRC messages for a gitlab push hook event.
        #
    ...
    def branch_url
      "#{gitlab_repository_url}/commits/#{branch_name}"
    end
    ...
    def before_sha_url
      "#{gitlab_repository_url}/commits/#{before_sha}"
    end
    ...
    def after_sha_url
      "#{gitlab_repository_url}/commits/#{after_sha}"
    end
